    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/Users/rajiv/OneDrive/Desktop/FacialRecognition/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Usersrajiv\OneDrive\Desktop\FacialRecognition\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Users/rajiv/OneDrive/Desktop/FacialRecognition/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\rajiv\OneDrive\Desktop\FacialRecognition\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'mahe' :
            if password == '121':
                ...
                cs = 'C:/Users/rajiv/OneDrive/Desktop/FacialRecognition/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
